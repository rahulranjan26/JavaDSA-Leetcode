...
public class FindAllSingleChildNodesCount {
...
//        n4.left = n9;
        n4.right = n10;
        System.out.println(countAllSingleChildNodes(root));

    }

    private static int countAllSingleChildNodes(Node root) {
        if (root == null || (root.left == null && root.right == null))
            return 0;
        if (root.left == null || root.right == null)
            return 1;
        return countAllSingleChildNodes(root.left) + countAllSingleChildNodes(root.right);
    }
}
